...
const contractAddress = '0xF1C59FbFB990089fD688D0D66Fa6ea519D68aEE5';

// Specify the interval between price updates in milliseconds
const updateInterval = 4000; // 3 secs
...
const contractABI = [
	{
		"inputs": [
			{
				"internalType": "contract Mytokenn",
				"name": "_MTN",
				"type": "address"
			},
			{
	...
	},
	{
		...
		"name": "RewardsClaimedWithIceToken",
		"type": "event"
	},
	{
		"anonymous": false,
	...
	},
	{
		...
		"name": "WithdrewdepositWithIceToken",
		"type": "event"
	},
	{
		"inputs": [
	...
	{
		"inputs": [],
		"name": "Contractbalance_for_IceToken",
		"outputs": [
			{
				"internalType": "uint256",
				"name": "",
	...
	},
	{
		...
		"name": "userBorrowedAmount_IceToken",
		"outputs": [
			{
				"internalType": "uint256",
				"name": "",
...
async function updatePrice() {
  try {
    ...
    // Call the updateCorePrice function on the contract with the adjusted gas price
    await connectedContract.updateCorePrice({ gasLimit: 4000000, gasPrice: adjustedGasPrice });
    console.log('Core Price updated successfully within the Contract');
  } catch (error) {
