...
import SupplyUSDCpage from "@PagesInfo/SupplyUSDCpage";
import WithdrawUSDCpage from "@PagesInfo/WithdrawUSDCpage";
            ...
            <div className="gap-2 flex flex-col">
              ...
              >
                ...
                <div>
                  {" "}
                  {tab1 == false ? <br /> : <br />}
                  {tab1 === false ? <SupplyUSDCpage /> : ""}
                  {tab1 === true ? <WithdrawUSDCpage /> : ""}
                </div>
              </div>
            </div>
          </Box>
