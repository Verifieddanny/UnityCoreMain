...
import SupplyIcepage from "@PagesInfo/SupplyIcepage";
import WithdrawIcepage from "@PagesInfo/WithdrawIcepage";
            ...
            <div className="gap-2 flex flex-col">
              ...
              >
                ...
                <div>
                  {" "}
                  {tab1 == false ? <br /> : <br />}
                  {tab1 === false ? <SupplyIcepage /> : ""}
                  {tab1 === true ? <WithdrawIcepage /> : ""}
                </div>
              </div>
            </div>
          </Box>
